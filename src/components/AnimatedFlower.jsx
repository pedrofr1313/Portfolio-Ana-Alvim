...
const AnimatedFlower = ({size,fill,stroke,y}) => {
  return (
    
<motion.svg initial="hidden" animate="visible" id="Camada_1"  xmlns="http://www.w3.org/2000/svg" viewBox={`0 ${y} 41.53 60 `} className={`${size} `}>
